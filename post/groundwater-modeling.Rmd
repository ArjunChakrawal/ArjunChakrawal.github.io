...
Caution:<br />
Any modeling exercise is build upon assumptions that simplifies the problem therefore the results should be interpreted carefully. In this case, model capture the general groundwater flow direction; however, it is very sensitive to hydraulic conductivities and recharge values. 
